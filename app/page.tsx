    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-indigo-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="bg-white rounded-3xl border border-orange-100 shadow-lg p-8 mb-8 flex items-center gap-6">
          {session.user?.image && (
            <img src={session.user.image} alt="Profile" className="w-20 h-20 rounded-2xl border-4 border-orange-200 shadow" />
          )}
          <div>
            ...
            <p className="text-gray-500 mt-1 font-medium">Welcome to <span className="text-orange-500 font-bold">BMSCE EDx</span></p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[1,2,3,4,5,6,7,8].map((sem) => (
            <button key={sem} onClick={() => router.push(`/semester/${sem}`)}
              className="bg-white hover:bg-orange-500 hover:text-white border-2 border-gray-200 hover:border-orange-500 rounded-2xl p-5 text-center font-black text-gray-700 text-lg transition-all duration-200 shadow-sm hover:shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button onClick={() => router.push("/question-papers")}
          ...
          <button onClick={() => router.push("/contact-faculty")}
          ...
          <button onClick={() => router.push("/faculty-portal")}
